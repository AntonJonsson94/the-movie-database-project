...
const trendingUrl = "https://api.themoviedb.org/3/trending/all/day?api_key=aa5ee409d52ded21ba46b85a22480907";
...
function printTrendingMovies() {
    const trendingCard = document.createElement("section");
    ...
    for(let i = 0; i < trendingMovies.length; i++){
        ...
        const movieTitleCard = document.createElement("p");
        movieTitleCard.innerHTML = trendingMovies[i].title;
        const movieRatingCard = document.createElement("p");
        movieRatingCard.innerHTML = `Rating: ${trendingMovies[i].rating.toString()}`;
        const goToMoviePageButton = document.createElement("input");
...
function printSearchResults() {
    const searchedMovieCard = document.createElement("section");
    ...
    for(let i = 0; i < searchedMovies.length; i++){
        ...
        const movieRatingCard = document.createElement("p");
        movieRatingCard.innerHTML = `Rating: ${searchedMovies[i].rating.toString()}`;
